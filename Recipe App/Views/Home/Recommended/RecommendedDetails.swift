...
struct RecommendedDetails: View {
    ...
    var body: some View {
        ScrollView{
            VStack(alignment: .center, spacing: 10){
                ZStack{
                    UrlImageView(urlString: recommended.image)
                    Button(action:{
                ...
                Group{
                    ...
                    VStack(alignment: .leading, spacing: 5){
                        ForEach(recommended.ingredients, id: \.self) { ingredients in
                            VStack(alignment: .leading, spacing: 5){
                                Text(ingredients)
                                    .font(.footnote)
                    ...
                    ForEach(recommended.instructions, id: \.self){ instruction in
